...
//            if (position == 0){
//                v = LayoutInflater.from(parent.getContext())
//                        .inflate(R.layout.steppers_item_without_cancel, parent, false);
//            }
        }
...
//        holder.buttonCancel.setEnabled(steppersItem.isButtonCancelEnabled());
//        steppersItem.addObserver(new Observer() {
//            @Override
//            public void update(Observable observable, Object data) {
//                if (observable != null) {
//                    SteppersItem item = (SteppersItem) observable;
//                    holder.buttonCancel.setEnabled(item.isButtonCancelEnabled());
//                }
//            }
//        });
//        holder.buttonCancel.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                if (steppersItem.getOnClickCancel() != null) {
//                    steppersItem.getOnClickCancel().onClick();
//                } else {
//                    prevStep();
//                }
//            }
//        });
//
//        if (steppersItem.isButtonCancelEnabled()) {
...
//---------------------------------------------------------------------------
    ...
    protected void nextStep() {
        changeToStepNext(currentStep + 1);
    }

    protected void prevStep() {
        changeToStepPrev(currentStep - 1);
    }

    protected void changeToStepNext(int position) {
        if (position != currentStep) {
    ...
    protected void changeToStepPrev(int position) {
        if (position != currentStep) {
            this.beforeStep = currentStep;
            this.currentStep = position;
            if (beforeStep < currentStep)
