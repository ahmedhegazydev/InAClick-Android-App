...
public class SteppersItem extends Observable {
    ...
    private OnClickCancelButton onClickCancel;
    private boolean buttonCancelEnabled = true;
    ...
    public OnClickCancelButton getOnClickCancel() {
        return onClickCancel;
    }

    public void setOnClickCancel(OnClickCancelButton onClickCancel) {
