...
public class AutoCompleteAdapter extends RecyclerView.Adapter<AutoCompleteAdapter.PredictionHolder> implements Filterable {
    ...
    public AutoCompleteAdapter(Context mContext, int mLayout, GoogleApiClient mGoogleApiClient, LatLngBounds mBounds,
                               AutocompleteFilter mPlaceFilter, PlaceAutoCompleteInterface mPlaceClickInterface) {
    ...
    */
    ...
    public static class PredictionHolder extends RecyclerView.ViewHolder {
        ...
        public PredictionHolder(View holder) {
            super(holder);
            mAddress1 = holder.findViewById(R.id.tvParentName);
            mAddress2 = holder.findViewById(R.id.tvChildName);
