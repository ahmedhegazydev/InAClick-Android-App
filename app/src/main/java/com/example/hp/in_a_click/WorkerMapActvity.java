package com.example.hp.in_a_click;
...
public class WorkerMapActvity extends FragmentActivity implements OnMapReadyCallback,
    ...
    private void findNearestDriver() {
        ...
        DatabaseReference drivers = FirebaseDatabase.getInstance().getReference("Riders");
...
//        DatabaseReference refAllDrivers = FirebaseDatabase.getInstance().getReference("Locations");
                  ...
                  ref
                        ...
                        .addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                UserNormal inAClickUser = dataSnapshot.getValue(UserNormal.class);

                                //add marker to all riders or drivers
                                mMap.addMarker(new MarkerOptions()
                                        .position(new LatLng(location.latitude, location.longitude))
                                        .title(inAClickUser.getUserPhone())
    ...
    private void initFindAllRiders() {

//        btnFindAllRiders = findViewById(R.id.btnFindAllDrivers);
//        btnFindAllRiders.setOnClickListener(new View.OnClickListener() {
//            @Override
...
//        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.driverWhereIam:

                findMe();
                break;
            case R.id.driverVisibleAllDrivers:
                loadAllAvailableDrivers();
                break;
            case R.id.driverSetAsOffline:
                setMeAsOffline();
                break;
            case R.id.driverSetAsOnline:
                setMeAsOnline();
    ...
    private void setMeAsOnline() {

        findMe();
        Snackbar.make(mapFragment.getView(), "You are Online Now", Snackbar.LENGTH_SHORT).show();
    }

    private void setMeAsOffline() {
        ...
        Snackbar.make(mapFragment.getView(), "You are Offline Now", Snackbar.LENGTH_SHORT).show();
    }
...
//            }
//        });
        if (getIntent().getStringExtra(MenuActivity.WHO).equalsIgnoreCase("Driver")) {
            ref = FirebaseDatabase.getInstance().getReference("Locations").child("Drivers");

        } else {//Home Owners
            ref = FirebaseDatabase.getInstance().getReference("Locations").child("HomeOwners");
        }
...
//            if (materialAnimatedSwitch.isChecked()) {
            ...
            geoFire.setLocation(FirebaseAuth.getInstance().getCurrentUser().getUid(), new GeoLocation(lat, lon), new GeoFire.CompletionListener() {
                ...
                public void onComplete(String key, DatabaseError error) {
                    Toast.makeText(WorkerMapActvity.this, "Location saved as " +
                            getIntent().getStringExtra(MenuActivity.WHO), Toast.LENGTH_LONG).show();
...
//        }
        ...
        new AlertDialog.Builder(this)
                .setPositiveButton("許可する", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ActivityCompat.requestPermissions(WorkerMapActvity.this,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMarkerClickListener(WorkerMapActvity.this);
