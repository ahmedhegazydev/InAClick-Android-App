...
public class UserMapActvity extends FragmentActivity implements OnMapReadyCallback,
...
//        DatabaseReference refAllDrivers = FirebaseDatabase.getInstance().getReference("Locations");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.map_user_trip);
...
//        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.userFindMe:
                findMe();
                break;
            case R.id.userLoadAllDrivers:
                loadAllAvailableDrivers();
                break;
...
//            if (materialAnimatedSwitch.isChecked()) {
            ...
            geoFire.setLocation(FirebaseAuth.getInstance().getCurrentUser().getUid(), new GeoLocation(lat, lon), new GeoFire.CompletionListener() {
                ...
                public void onComplete(String key, DatabaseError error) {
                    Toast.makeText(UserMapActvity.this, "Location saved as " +
...
//        }
        ...
        new AlertDialog.Builder(this)
                .setPositiveButton("許可する", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ActivityCompat.requestPermissions(UserMapActvity.this,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMarkerClickListener(UserMapActvity.this);
