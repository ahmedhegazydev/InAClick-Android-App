package com.example.hp.in_a_click.location_alarm;
...
public class DriverMapActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    DatabaseReference refMyLOcationForAlarm = null;
    ...
    private void loadAllAvailableDrivers() {
        ...
        DatabaseReference refAllDrivers = FirebaseDatabase.getInstance().getReference("Riders");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refMyLOcationForAlarm = FirebaseDatabase.getInstance().getReference("MyLocation");
        geoFire = new GeoFire(refMyLOcationForAlarm);
...
//    }
    ...
    private void displayLocation() {
        ...
        if (location != null) {
            ...
            geoFire.setLocation("You", new GeoLocation(lat, lon), new GeoFire.CompletionListener() {
                @Override
...
//        }
    ...
    private void sendNotification(String title, String message, String key) {

        Notification.Builder mBuilder =
                new Notification.Builder(DriverMapActivity.this)
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
        ...
        LatLng dangerousArea = new LatLng(29.9819802, 31.1805239);
        ...
        GeoQuery checkMyLocationForAlarm = geoFire.queryAtLocation(new GeoLocation(dangerousArea.latitude, dangerousArea.longitude), .5f);//.5f = .5km = 500m
        checkMyLocationForAlarm.addGeoQueryEventListener(new GeoQueryEventListener() {
            @Override
            public void onKeyEntered(String key, GeoLocation location) {
                sendNotification("InAClick", "onKeyEntered", key);
            }

            @Override
            public void onKeyExited(String key) {
                sendNotification("InAClick", "onKeyExited", key);
            }

            @Override
            public void onKeyMoved(String key, GeoLocation location) {
                sendNotification("InAClick", "onKeyMoved", key);
            }
